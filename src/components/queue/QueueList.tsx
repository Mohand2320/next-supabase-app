...
function SortableRow({ item, index, items, onStatusChange, onMoveUp, onMoveDown }: {
  item: FileAttente;
  index: number;
  items: FileAttente[];
  onStatusChange: (id: string, newStatus: StatutQueue) => void;
  ...
  return (
    <>
      {/* Mobile card */}
      <div ref={setNodeRef} style={style} className="block sm:hidden p-4 space-y-3">
      ...
      {/* Desktop row */}
      <tr ref={setNodeRef} style={style} className="hidden sm:table-row hover:bg-slate-50 transition-colors">
